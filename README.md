...
<h1>Requirements:</h1>
 ...
 <h1> FEATURES </h1>   <br>
  ...
  <h1> WORKING.. </h1>
    1. you can see songs without any creditials and for other parts you have to register first <br>
    2. you can search songs by songs name <br>
    3. by click own add song button it wil redirect to artist page where you can add song and also add artist <br>
    4. for viewing artist you can also go through navigation bar it will help you to redirects in specific page <br>
